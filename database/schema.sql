-- AssetSim Pro Database Schema with Idempotent Guards
-- This schema can be run multiple times safely (development & CI/CD)
-- Uses IF NOT EXISTS guards for all objects
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[Exchanges]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[ExchangeRoles]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[ExchangeConfigurations]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[Instruments]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[Portfolios]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[Positions]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[Orders]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[MarketData]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[OHLC_1M]') AND type in (N'U'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Security].[fn_securitypredicate]') AND type in (N'IF', N'FN', N'TF'))
BEGIN
    EXEC('
...
-- 3. Apply Policy to Portfolios (idempotent check)
IF NOT EXISTS (SELECT * FROM sys.security_policies WHERE name = 'PortfolioPolicy')
BEGIN
...
-- 4. Apply Policy to Orders (idempotent check)
IF NOT EXISTS (SELECT * FROM sys.security_policies WHERE name = 'OrderPolicy')
BEGIN
...
-- 5. Apply Policy to MarketData (idempotent check)
IF NOT EXISTS (SELECT * FROM sys.security_policies WHERE name = 'MarketDataPolicy')
BEGIN
...
-- 6. Apply Policy to OHLC data (idempotent check)
IF NOT EXISTS (SELECT * FROM sys.security_policies WHERE name = 'OHLCPolicy')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[ExchangeFeatureFlags]') AND type in (N'U'))
BEGIN
...
-- 7. Apply RLS Policy to Exchange Feature Flags (idempotent check)
IF NOT EXISTS (SELECT * FROM sys.security_policies WHERE name = 'ExchangeFeatureFlagsPolicy')
BEGIN
...
-- Aggregate raw ticks into 1-minute OHLC candles (idempotent check)
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[sp_AggregateOHLC_1M]') AND type in (N'P', N'PC'))
BEGIN
    EXEC('
...
-- Clean up hot path data older than 7 days (idempotent check)
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Trade].[sp_CleanupHotPath]') AND type in (N'P', N'PC'))
BEGIN
    EXEC('
